      ...
      <View style={styles.container}>
        {score > 49 ? (
          <View>
            ...
            <View style={{ textAlign: 'center', width: '100%', marginHorizontal: 'auto'}}>
              <Text style={{color: 'green',fontSize: 16, fontWeight: 'bold', margin: 20}}>Συγχαρητήρια!!! Πέτυχες την απαιτούμενη βαθμολογία για να προχωρήσεις στο επόμενο επίπεδο.</Text>
              <Text style={{color: 'magenta',fontSize: 18, fontWeight: 'bold', marginBottom: 10}}>Σωστές Απαντήσεις</Text>
            </View>
            <View
              style={{
                flexDirection: "row",
            ...
            >
              <Text style={{ fontWeight: "bold", padding: 2, fontSize: 16, color: 'darkblue', textDecorationLine: 'underline' }}>Νομός</Text>
              <Text style={{ fontSize: 16, color: 'darkblue', fontWeight: 'bold', textDecorationLine: 'underline' }}>Πρωτεύουσα</Text>
            </View>
